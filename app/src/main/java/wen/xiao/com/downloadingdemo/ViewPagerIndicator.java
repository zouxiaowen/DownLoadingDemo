...
public class ViewPagerIndicator extends LinearLayout {
     ...
     * 标题选中时的颜色
     */
    private static final int COLOR_TEXT_HIGHLIGHTCOLOR = 0xFFf57c00;
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        mPaint.setColor(ContextCompat.getColor(context, R.color.download_stop));
	...
	private TextView generateTextView(String text)
	{
        ...
        tv.setText(text);
//        tv.setTextSize(20);
        tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16.5f);   //修改text大小
    ...
    private void iniTrectangle() {
        mPath = new Path();
        mPath.rewind();
        mTriangleHeight = (int) (mTriangleH / 2 / Math.sqrt(2));//指示条的高度

        mPath.moveTo(mTriangleWidth, mTriangleHeight / 4);
        mPath.lineTo(-mTriangleWidth / 100, mTriangleHeight / 4);
        mPath.lineTo(-mTriangleWidth / 100, -mTriangleHeight / 4);
        mPath.lineTo(mTriangleWidth, -mTriangleHeight / 4);
        mPath.close();
    }
